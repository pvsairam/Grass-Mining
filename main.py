...
def welcome_screen():
  ...
  / _ \ / __|   /_\ |_ _| _ \   \| _ \/ _ \| _ \
 | (_) | (_ |  / _ \ | ||   / |) |   / (_) |  _/
  \___/ \___| /_/ \_\___|_|_\___/|_|_\\___/|_|  
                                                
""")
    print(YELLOW + BRIGHT + "Channel: https://t.me/Airdrop_OG\n".center(80))
    for _ in range(3):
...
async def fetch_proxies_periodically(interval, user_id):
    while True:
        print(CYAN + BRIGHT + "Choose Proxy URL:")
        ...
        choice = input("Choose Proxy URL (1-6): ")
...
async def main(interval):
    welcome_screen()
    user_id = input(MAGENTA + "Enter User ID: ")
